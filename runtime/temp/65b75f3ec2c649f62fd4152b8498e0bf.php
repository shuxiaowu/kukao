...
<body>
 ...
 <div class="pubmain">
  ...
  <div class="panel-heading">
   ...
   <div class="pull-right mar10"><?php echo btn(array('vals'=>'添加资料','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>url('website/dataadd','sty='.$sty.'&tables='.$dshow['table'].'&martables='.$dshow['martable']).'?index_id='.$num_index)); ?></div>
   ...
   <tr class="maintr">
    ...
    <td align="left" valign="middle">
     ...
     <?php if($obj['pic'] != ''): ?>
      ...
      <a href="javascript:void(0)"<?php echo imgshow($obj['pic']); ?>><?php echo icon('picture'); ?></a>
    ...
    <td align="center" valign="middle">
     ...
     <a href="javascript:void(0)" data-url="<?php echo url('Website/article','id='.$obj['Id'].'&tables='.$dshow['table']); ?>" data-title="<?php echo $obj['topic']; ?>" class="showdata">

      <?php echo btn(array('vals'=>'预览','icon'=>'globe','scene'=>'success','round'=>1,'tips'=>'点击预览数据')); ?>

     </a>

     <?php echo btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','round'=>1,'url'=>url('website/datamod','tables='.$dshow['table'].'&martables='.$dshow['martable'].'&id='.$obj['Id']).'?index_id='.$num_index)); ?>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger btn-rounded btn-sm" data-dismiss="modal"><?php echo icon('off'); ?> 关闭</button>
