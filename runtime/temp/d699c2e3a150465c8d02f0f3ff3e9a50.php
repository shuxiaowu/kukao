<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:54:"D:\phpStudy\WWW\bofang/app/home\view\article\index.tpl";i:1568269876;s:54:"D:\phpStudy\WWW\bofang\app\home\view\common\common.tpl";i:1568018048;s:59:"D:\phpStudy\WWW\bofang\app\home\view\common\mobile_head.tpl";i:1568189833;s:54:"D:\phpStudy\WWW\bofang\app\home\view\common\header.tpl";i:1568268293;s:60:"D:\phpStudy\WWW\bofang\app\home\view\common\common_right.tpl";i:1568269923;s:54:"D:\phpStudy\WWW\bofang\app\home\view\common\footer.tpl";i:1568018490;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="/bofang/public/home/css/share.css" />
...
<!-- 顶部end -->
    ...
    <div class="mobile_art hidden-lg mobile_content">
        ...
        <div class="container">
            ...
            <div class="pull-left"><?php echo subtext($data['date'],0,11); ?></div>

            <div class="pull-right">

                <p><img src="/bofang/public/home/images/eye.png" class="eye"></p>

                <p><?php echo $data['hit']; ?></p>
            ...
            <div class="content_left">
                ...
                <div class="address_links visible-lg">
                    ...
                    <p>
                        ...
                        当前位置：<a href="<?php echo url('/'); ?>">首页</a>><?php if(!(empty($mark) || (($mark instanceof \think\Collection || $mark instanceof \think\Paginator ) && $mark->isEmpty()))): ?><a href="<?php echo url('home/index/degree',['urlname'=>$mark]); ?>"><?php echo $mark; ?></a>><?php endif; ?> <a href=""><?php echo $title; ?></a>
                ...
                <div class="content_article">
                    ...
                    <div class="content_head visible-lg">
                        ...
                        <div class="art_title"
                            ...
                            <?php echo $data['topic']; ?></div>

                        <div class="art_intro">

                            <div class="art_left pull-left">来源：<?php echo $sysconf['companyname']; ?> | <?php echo subtext($data['date'],0,11); ?></div>
                            ...
                            <script src="/bofang/public/home/js/ZeroClipboard.js"></script>
                    ...
                    <div class="content_con">
                        ...
                        <!-- <p>
                            ...
                            <img src="/bofang/public/home/images/art.jpg" width="100%">
                    ...
                    <div class="up_down">
                        ...
                        <div class="up_con pull-left">
                            ...
                            <?php if($tops == '0'): ?><a href="javascript:;">无</a><?php else: ?> <a href="<?php echo url('home/article/index',['Id'=>$top['Id']]); ?>" title="<?php echo $top['topic']; ?>" alt="<?php echo $top['topic']; ?>"><?php echo $top['topic']; ?></a><?php endif; ?>
                        ...
                        <div class="down_con pull-right">
                            ...
                            <?php if($nexts == '0'): ?><a href="javascript:;">无</a><?php else: ?> <a href="<?php echo url('home/article/index',['Id'=>$next['Id']]); ?>" title="<?php echo $next['topic']; ?>" alt="<?php echo $next['topic']; ?>"><?php echo $next['topic']; ?></a><?php endif; ?>
            ...
            <?php if(is_array($tjvideo) || $tjvideo instanceof \think\Collection || $tjvideo instanceof \think\Paginator): $i = 0; $__LIST__ = $tjvideo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
                ...
                <div class="videob1">
                    ...
                    <div class="video1_listen">
                        ...
                        <p class="vl1_left"><?php echo gettopic('course',$obj['course']); ?></p>
