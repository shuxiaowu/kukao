<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"D:\phpStudy\WWW\bofang/app/home\view\index\team.tpl";i:1568190778;s:54:"D:\phpStudy\WWW\bofang\app\home\view\common\common.tpl";i:1568018048;s:59:"D:\phpStudy\WWW\bofang\app\home\view\common\mobile_head.tpl";i:1568189833;s:54:"D:\phpStudy\WWW\bofang\app\home\view\common\header.tpl";i:1568268293;s:54:"D:\phpStudy\WWW\bofang\app\home\view\common\footer.tpl";i:1568018490;}*/ ?>
<!DOCTYPE html>
...
<!-- 顶部end -->
    ...
    <div id="team_homepic">
        ...
        <img src="/bofang/public/home/images/teampic.jpg" width="100%">
            ...
            <div class="mobile_slider">
                ...
                <div class="swiper-container" id="myzhibo">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide"><a href="<?php echo url('home/index/team',['type'=>0]); ?>" <?php if($type == '0'): ?> class="select"<?php endif; ?>>全部</a></div>
                        ...
                        <?php if(is_array($dataType) || $dataType instanceof \think\Collection || $dataType instanceof \think\Paginator): $i = 0; $__LIST__ = $dataType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
                            <div class="swiper-slide"><a href="<?php echo url('home/index/team',['type'=>$obj['Id']]); ?>" <?php if($type == $obj['Id']): ?> class="select"<?php endif; ?>>数学</a></div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <li>
                            ...
                            <a href="javascript:;" title="" alt="">
                                ...
                                <div class="tt_right">
                                    ...
                                    <p class="tt_name oneline"><?php echo $obj['topic']; ?></p>

                                    <p class="tt_touxian"><?php echo $obj['joptitle']; ?></p>
        ...
        <?php if(is_array($dataType) || $dataType instanceof \think\Collection || $dataType instanceof \think\Paginator): $i = 0; $__LIST__ = $dataType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
            ...
            <div id="team_title">
                ...
                <div class="container">
                    ...
                    博方考研<span style="color:#0060ad"><?php echo $obj['topic']; ?></span>辅导核心团队
            ...
            <div id="team_teacher">
                ...
                <div class="container">
                    ...
                    <ul class="tt_ul">
                        ...
                        <?php if(is_array($obj['datatypes']) || $obj['datatypes'] instanceof \think\Collection || $obj['datatypes'] instanceof \think\Paginator): $i = 0; $__LIST__ = $obj['datatypes'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            ...
                            <li>
                                ...
                                <a href="" title="" alt="">
                                    ...
                                    <div class="tt_left">
                                        ...
                                        <img src="<?php echo npic($vo['pic']); ?>">

                                    </div>

                                    <div class="tt_right">

                                        <p class="tt_name"><?php echo $vo['topic']; ?></p>

                                        <p class="tt_touxian"><?php echo $vo['joptitle']; ?></p>

                                        <p class="tt_intro"><?php echo $vo['intro']; ?>
