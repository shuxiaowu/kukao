            ...
            <div class="content_left">
                ...
                <div class="address_links">
                    ...
                    <p>
                        ...
                        当前位置：<a href="<?php echo url('/'); ?>">首页</a>><a href=""><?php echo $mark; ?></a>><a href=""><?php echo $title; ?></a>
                ...
                <div class="yeartest_top">
                    ...
                    <div class="yt_subject">
                        ...
                        <a href="<?php echo url('home/index/mbaMoreBtn',['sty'=>$sty,'mark'=>$mark,'type'=>0]); ?>" <?php if($type == '0'): ?>class="type"<?php endif; ?>>全部</a>
                        ...
                        <?php if(is_array($dataType) || $dataType instanceof \think\Collection || $dataType instanceof \think\Paginator): $i = 0; $__LIST__ = $dataType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?>
                            ...
                            <a href="<?php echo url('home/index/mbaMoreBtn',['sty'=>$sty,'mark'=>$mark,'type'=>$obj['Id']]); ?>" <?php if($type == $obj['Id']): ?>class="type"<?php endif; ?>><?php echo $obj['topic']; ?></a>
