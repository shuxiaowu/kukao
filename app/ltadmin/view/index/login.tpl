  ...
  <if condition="$data['adminpath'] eq ''">
    ...
    <script type="text/javascript">
      ...
      function gcode() {
        ...
        var files = "{:url('ltadmin/index/logincode','','')}";
      ...
      $(".i-login-btn").click(function (e) {
        ...
        $.post("{:url('ltadmin/index/checklogin')}", { 'user': user, 'pass': pass, 'code': code }, function (data) {
          ...
          if (data == 1) {
            ...
            window.location.href = "{:url('ltadmin/index/index')}";
