...
<block name="main">
 ...
 <div class="pubmain">
  ...
  <div class="panel-heading">
   ...
   <h3 class="panel-title pull-left">日历管理</h3>

   <div class="pull-right mar10">{:btn(array('vals'=>'添加','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>url('website/calendaradd','tables='.$dshow['table'].'&sty='.$sty).'?index_id='.$num_index))}</div>
  ...
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   ...
   <tr class="active">
     ...
     <td align="left" valign="middle">考研方向</td>

     <td align="left" valign="middle">选择院校</td>

     <td align="left" valign="middle">选择专业</td>
  ...
  <tr class="maintr">
    ...
    <td align="left" valign="middle">{$obj['direct']}</td>

    <td align="left" valign="middle">{$obj['school']}</td>

    <td align="left" valign="middle">{$obj['changemajor']}</td>
    ...
    <td align="center" valign="middle">{:btn(array('vals'=>'编辑','icon'=>'edit','round'=>1,'tips'=>'点击编辑数据','url'=>url('calendarmod','tables='.$dshow['table'].'&id='.$obj['Id']).'?index_id='.$num_index))}
